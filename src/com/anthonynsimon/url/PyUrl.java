 ...
 */
public class PyUrl implements Serializable {
     ...
     * Do not serialize.
     */
    private transient Map<String, PyStrings> parsedQueryPairs;
     ...
     */
    PyUrl(String scheme, String username, String password, String host, String path, String query, String fragment, String opaque) {
    ...
    PyUrl(String scheme, String username, String password, String host, String path, String rawPath, String query, String fragment, String opaque) {
        this.scheme = mapToNullIfEmpty(scheme);
        this.username = mapToNullIfEmpty(username);
        this.password = mapToNullIfEmpty(password);
        this.host = mapToNullIfEmpty(host);
    ...
    PyUrl(String scheme, String username, String password, String hostname, Integer port, String path, String rawPath, String query, String fragment, String opaque) {
        this.scheme = mapToNullIfEmpty(scheme);
        this.username = mapToNullIfEmpty(username);
        this.password = mapToNullIfEmpty(password);
     ...
     */
    public static PyUrl parse(String url) throws MalformedURLException {
     ...
     */
    public Map<String, PyStrings> getQueryPairs() {
        ...
        if (!nullOrEmpty(query) && !query.equals("?")) {
            ...
            for (String pair : pairs) {
                ...
                if (parts.length > 0 && !parts[0].isEmpty()) {
                    ...
                    PyStrings existing = parsedQueryPairs.getOrDefault(parts[0], new PyStrings());
                    if (parts.length == 2) {
    ...
    public PyUrl resolveReference(String ref) throws MalformedURLException, InvalidURLReferenceException {
        PyUrl url = URL_PARSER.parse(ref);
     ...
     */
    public PyUrl resolveReference(PyUrl ref) throws InvalidURLReferenceException {
        if (!isAbsolute()) {
	...
	public String qFirst(String key) {
		PyStrings query = getQueryPairs().get(key);
		if(query.notEmpty())
			return query.get(0);
		return null;
	}
	public int qInt(String key, int def){
		String value = qFirst(key);
		if(value == null)
			return def;
