...
public class GeoHashQuery {
    ...
    public static final class Utils {
        ...
        public static double bitsLongitude(double resolution, double latitude) {
            double degrees = Geo.distanceToLongitudeDegrees(resolution, latitude);
        ...
        public static int bitsForBoundingBox(GeoLocation location, double size) {
            double latitudeDegreesDelta = Geo.distanceToLatitudeDegrees(size);
    ...
    public static Set<GeoHashQuery> queriesAtLocation(GeoLocation location, double radius) {
        ...
        double longitudeDeltaNorth = Geo.distanceToLongitudeDegrees(radius, latitudeNorth);
        double longitudeDeltaSouth = Geo.distanceToLongitudeDegrees(radius, latitudeSouth);
        ...
        GeoHash geoHashW = new GeoHash(latitude, Geo.wrapLongitude(longitude - longitudeDelta), geoHashPrecision);
        GeoHash geoHashE = new GeoHash(latitude, Geo.wrapLongitude(longitude + longitudeDelta), geoHashPrecision);

        GeoHash geoHashN = new GeoHash(latitudeNorth, longitude, geoHashPrecision);
        GeoHash geoHashNW = new GeoHash(latitudeNorth, Geo.wrapLongitude(longitude - longitudeDelta), geoHashPrecision);
        GeoHash geoHashNE = new GeoHash(latitudeNorth, Geo.wrapLongitude(longitude + longitudeDelta), geoHashPrecision);

        GeoHash geoHashS = new GeoHash(latitudeSouth, longitude, geoHashPrecision);
        GeoHash geoHashSW = new GeoHash(latitudeSouth, Geo.wrapLongitude(longitude - longitudeDelta), geoHashPrecision);
        GeoHash geoHashSE = new GeoHash(latitudeSouth, Geo.wrapLongitude(longitude + longitudeDelta), geoHashPrecision);
